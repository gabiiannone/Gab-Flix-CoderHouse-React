...
const ItemList = () => {
          ...
          <>
            {
              ...
              products.map((product) => {
                ...
                // acá tenemos el uso de map, que basicamente está retornando un div con nuestro
                // item adentro tantas veces como productos tenga en mi array de productos (nótese la propiedad key a la cual asigno el id para que react pueda identificar 
               //los nodos que se van creando y así los pueda diferenciar). Por favor leer la documentación de map en MDN
               return (
                <div key={product.id}>
                  <Cards
  ...
  //https://stackblitz.com/edit/react-phgbre